  ...
  {/* Dynamic Initial Logo */}
              {!isLoading && (
                <img 
                  src={`https://ui-avatars.com/api/?name=${profileData.businessName.split(' ').join('+')}&background=0f172a&color=fff&bold=true&size=128`} 
                  alt="Business Logo" 
                  className="w-16 h-16 rounded shadow-sm mb-6 object-cover"
                />
              )}
