...
const TrustReport = () => {
  ...
  useEffect(() => {
    const fetchReportData = async () => {
      ...
      try {
        ...
        // A. Fetch Profile (Added business_type for the header)
  ...
  // UPGRADED: Replaced alert() with a professional Toast notification
  const handleShare = () => {
                ...
                <div className="p-6 md:p-12">
                    ...
                    <div className="overflow-x-auto w-full border border-slate-100 rounded-2xl">
                      <div className="min-w-[600px] divide-y divide-slate-50">
                        {reportData.recentTransactions ? (
                          ...
                          <>
                            <ReportTableRow initial="AS" client="Aether Systems" type="Infrastructure Audit" date="Oct 21, 2026" />
                            <ReportTableRow initial="QC" client="Quantum Core" type="Data Pipeline Sync" date="Oct 19, 2026" />
                            <ReportTableRow initial="SN" client="Solaris Networks" type="Smart Contract Deploy" date="Oct 15, 2026" />
                          </>
                        )}
                      </div>
                    </div>
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-6">
                      ...
                      {/* NEW: Makes the section feel interactive */}
...
const ReportTableRow = ({ initial, client, type, date }) => (
  <div className="flex items-center justify-between py-4 px-6 hover:bg-slate-50/50 transition-colors gap-4">
    ...
    <div className="flex items-center justify-between w-1/3 min-w-[150px]">
      ...
      <span className="bg-emerald-50 text-emerald-600 px-2.5 py-1 rounded text-[9px] font-black uppercase tracking-widest shrink-0 border border-emerald-100 shadow-sm">Verified</span>
    </div>
  </div>
);
