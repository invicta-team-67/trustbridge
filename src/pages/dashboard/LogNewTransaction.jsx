    ...
    <div className="flex min-h-screen bg-[#F8FAFC] font-sans text-slate-700 relative overflow-x-hidden">
      ...
      <main className="flex-1 lg:ml-64 min-h-screen flex flex-col w-full">
        ...
        <motion.div 
          ...
          className="p-4 md:p-12 flex flex-col items-center w-full"
        >
          <div className="w-full max-w-3xl">
            <div className="text-center mb-8 md:mb-10">
              <h1 className="text-2xl md:text-3xl font-bold text-slate-900 mb-2">Log New Transaction</h1>
              <p className="text-slate-500 text-sm">Enter the details of the service provided to record a new entry in the trust ledger.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="bg-white border border-slate-200 rounded-3xl p-6 md:p-10 shadow-sm space-y-6 md:space-y-8">
              {/* Row 1: Stacks on mobile, 2 columns on desktop */}
              ...
              <div className="space-y-3">
                ...
                <div 
                  ...
                  className="border-2 border-dashed border-[#dbeafe] bg-[#f8fafc] rounded-2xl p-6 md:p-10 flex flex-col items-center justify-center cursor-pointer hover:bg-[#f1f5f9] transition-all group"
                >
                  <input 
                    type="file" 
                    ref={fileInputRef} 
              ...
              <div className="flex flex-col-reverse sm:flex-row gap-4 pt-4">
                <button 
                  ...
                  className="w-full sm:flex-1 py-3.5 border border-slate-200 rounded-xl text-sm font-bold text-slate-500 hover:bg-slate-50 transition-all"
                >
                  Cancel
                </button>
                <button 
                  ...
                  className="w-full sm:flex-[1.5] py-3.5 bg-[#1e40af] text-white rounded-xl text-sm font-bold shadow-lg shadow-blue-900/10 hover:bg-blue-800 transition-all flex items-center justify-center gap-2"
                >
