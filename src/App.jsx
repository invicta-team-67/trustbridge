    ...
    <main className="max-w-7xl mx-auto px-6 lg:px-12 py-12 lg:py-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      <motion.div variants={containerVariants} initial="hidden" animate="visible" className="flex flex-col gap-6 z-10">
        ...
        <motion.div variants={itemVariants} className="flex flex-wrap items-center gap-4 mt-4">
          <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="bg-[#1a56db] text-white px-6 py-3 rounded-md font-semibold shadow-lg shadow-blue-500/30 hover:bg-blue-700 transition-colors w-full sm:w-auto">
            Create Account
          </motion.button>
          <motion.button whileHover={{ scale: 1.05, backgroundColor: "#f1f5f9" }} whileTap={{ scale: 0.95 }} className="bg-white text-gray-700 px-6 py-3 rounded-md font-semibold border border-gray-200 shadow-sm transition-colors w-full sm:w-auto text-center">
            Learn more
          </motion.button>
        </motion.div>
