  ...
  return (
    <Router>
      <Routes>
        ...
        {/* Dashboard & TrustBridge Ecosystem (SMEs) */}
        ...
        {/* --- NEW: INSTITUTIONAL & SENTINEL ROUTES --- */}
        
        {/* The public-facing Sentinel Landing Page (Lead generation for lenders) */}
        <Route path="/sentinel" element={<TrustBridgeSentinel />} />
        
        {/* The dynamic lookup route (Catches the search query e.g., /lookup/TB-12345) */}
        <Route path="/lookup/:id" element={<SentinelLookupResult />} />
        
        {/* The Institutional Risk Vault (For the lender to view their portfolio) */}
        <Route path="/institutional-vault" element={<InstitutionalVault />} />
        
        {/* The Institutional Lending Dashboard (For the SME to see their Tier 1 Capital access) */}
